	...
	jQuery(document)
			.ajaxError(
					function(event, jqXHR, settings, thrownError) {
						console
								.log("CommonHead_BootstrapFlat.jsp: .ajaxError 進行全域捕捉 error:");
						console.log("CommonHead_BootstrapFlat.jsp: event="
								+ event);
						console
								.log("CommonHead_BootstrapFlat.jsp: jqxhr.responseText="
										+ jqXHR.responseText);
