...
public class Exam {
	...
	private Timestamp scoreboardbegin;
	@Persistent(name = "step2scoreboardbegin")
	private Timestamp step2scoreboardbegin;
	...
	public void setTitle(String title) throws DataException {
		if (title == null) {
			throw new DataException("沒有填寫標題。");
		}
		this.title = title;
	}
	...
	// try {
	// return mapper.readValue(subjects, String[].class);
	...
	// public void setSubjects(String[] subjects) {
	// try {
	// this.subjects = mapper.writeValueAsString(subjects);
	...
	// public ZHENGSHIDAILI[] getZhengshidailis() {
	// return zhengshidailis;
	// }
	//
	// public void setZhengshidailis(ZHENGSHIDAILI[] zhengshidailis) {
	// this.zhengshidailis = zhengshidailis;
	// }
	//
	// public void setZhengshidailis(String zhengshidailis) {
	// try {
	// this.setZhengshidailis(mapper.readValue(zhengshidailis,
	// ZHENGSHIDAILI[].class));
	// } catch (JsonParseException e) {
	// e.printStackTrace();
	// } catch (JsonMappingException e) {
	...
	// }
	//
	// public NIANDUAN[] getNianduans() {
	// return nianduans;
	// }
	//
	// public void setNianduans(NIANDUAN[] nianduans) {
	// this.nianduans = nianduans;
	// }
	//
	// public void setNianduans(String nianduans) {
	// try {
	// this.setNianduans(mapper.readValue(nianduans, NIANDUAN[].class));
	// } catch (JsonParseException e) {
	// e.printStackTrace();
	// } catch (JsonMappingException e) {
	// e.printStackTrace();
	...
	// public void setSubjects(String subjects) {
	// try {
	// this.setSubjects(mapper.readValue(subjects, String[].class));
	// } catch (JsonParseException e) {
	// e.printStackTrace();
	// } catch (JsonMappingException e) {
	// e.printStackTrace();
	...
	public void setDeadline(String deadline) {
		try {
			...
			throw new DataException("繳費截止日期設定有誤，(" + deadline + ") 不是正確的日期格式");
		}
	}
	...
	public void setMoney(String money) throws DataException {
